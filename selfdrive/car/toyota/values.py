...
DBC = {
  ...
  CAR.COROLLA_TSS2: dbc_dict('toyota_nodsu_pt_generated', 'toyota_tss2_2022_adas'),
  ...
  CAR.RAV4H_TSS2: dbc_dict('toyota_nodsu_hybrid_pt_generated', 'toyota_tss2_2022_adas'),
...
# Radar currently undecoded. Forgo Radar Support.
TSS2_2022_RADAR_CAR = {CAR.COROLLA_TSS2, CAR.RAV4H_TSS2}
